...
export function DeepSeekOnboardingDialog(props) {
    ...
    return (_jsxs(OnboardingModal, { title: t('onboardingTitle'), children: [_jsx("p", { className: styles.description, children: t('onboardingDescription') }), _jsx("div", { className: styles.editor, children: _jsx(ProviderEditor, { provider: row.entry.provider, displayName: row.entry.displayName, namespace: namespace, schema: schema, settingsPath: row.entry.settingsPath, operations: operations, ...modelCapabilities === undefined ? {} : { modelCapabilities }, t: t, readOnly: false, hideTitle: true, credentialOnly: true, credentialRequired: true, autoFocusCredential: true, cancelLabelKey: "onboardingLater", submitLabelKey: "onboardingSave", submitBusyLabelKey: "onboardingSaving", onClose: finishCredential, normalizeProviderProfile: normalizeProviderProfile }) })] }));
}
