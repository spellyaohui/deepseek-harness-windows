...
export type ProviderProfileNormalizer = (provider: string, value: ProviderProfileDraft) => ProviderProfileNormalization;
...
export declare function normalizeProviderProfile(provider: string, value: ProviderProfileDraft, normalize?: ProviderProfileNormalizer): ProviderProfileNormalization;
