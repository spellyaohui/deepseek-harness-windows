 ...
 */
import type { CredentialInfo, LlmConfigurableProvider, LlmDiscoveredModel, LlmModelDiscoveryRequest, LlmProviderInfo, SettingsNamespaceView, SettingsPathOpView } from '@deepseek-ai/dsh-api-remotes/client';
 ...
 */
export declare function createModelsOperations(ctx: ModelsRemoteContext): ModelsOperations;
