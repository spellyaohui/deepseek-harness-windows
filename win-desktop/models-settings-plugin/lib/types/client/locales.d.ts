...
export declare const en: {
    ...
    capabilitySelectModel: string;
    capabilitySelectAll: string;
    capabilityDeselectAll: string;
    ...
    capabilityNotApplicable: string;
    capabilityCompleted: string;
    capabilityCancelled: string;
    capabilitySelectModelFirst: string;
    capabilityNeedsBaseUrl: string;
    capabilityNeedsProtocol: string;
