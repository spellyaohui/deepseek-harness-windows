window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		async function openAgentTeamMember(sessions, parentSessionId, childSessionId, layout) {
		...
		*/
		function apply(ctx) {
			...
			const openMember = (parentId, childId) => {
				openAgentTeamMember(ctx.sessions, parentId, childId, ctx.layout).catch((error) => {
