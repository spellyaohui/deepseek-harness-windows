	...
	factory: (require) => {
		...
		*/
		...
		var AgentTeamsCard_module_css_default = {
			"head": "C0pAHW_head",
			"leadAvatar": "C0pAHW_leadAvatar",
			"member": "C0pAHW_member",
			"memberArt": "C0pAHW_memberArt",
			"memberCount": "C0pAHW_memberCount",
			"memberInitial": "C0pAHW_memberInitial",
			"memberName": "C0pAHW_memberName",
			"members": "C0pAHW_members",
			"panelButton": "C0pAHW_panelButton",
			"root": "C0pAHW_root",
			"teamName": "C0pAHW_teamName"
		};
		//#endregion
		...
		* (historical session review). */
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "caqsjG_agentTeamsBreathe",
			"agentTeamsDot": "caqsjG_agentTeamsDot",
			"agentTeamsFloat": "caqsjG_agentTeamsFloat",
			"agentTeamsPanelIn": "caqsjG_agentTeamsPanelIn",
			"agentTeamsPulse": "caqsjG_agentTeamsPulse",
			"agentTeamsThink": "caqsjG_agentTeamsThink",
			"agentTeamsUnreadPulse": "caqsjG_agentTeamsUnreadPulse",
			"archiveLabel": "caqsjG_archiveLabel",
			"assignmentChip": "caqsjG_assignmentChip",
			"assignmentLabel": "caqsjG_assignmentLabel",
			"assignmentLine": "caqsjG_assignmentLine",
			"assignmentTasks": "caqsjG_assignmentTasks",
			"badge": "caqsjG_badge",
			"badgeCount": "caqsjG_badgeCount",
			"badgeDot": "caqsjG_badgeDot",
			"captainAvatar": "caqsjG_captainAvatar",
			"captainInfo": "caqsjG_captainInfo",
			"captainLine": "caqsjG_captainLine",
			"captainName": "caqsjG_captainName",
			"captainNode": "caqsjG_captainNode",
			"captainRole": "caqsjG_captainRole",
			"captainState": "caqsjG_captainState",
			"captainSummary": "caqsjG_captainSummary",
			"chevron": "caqsjG_chevron",
			"dagCanvas": "caqsjG_dagCanvas",
			"dagEdges": "caqsjG_dagEdges",
			"dagNode": "caqsjG_dagNode",
			"dagNodeDot": "caqsjG_dagNodeDot",
			"dagNodeHead": "caqsjG_dagNodeHead",
			"dagNodeLabel": "caqsjG_dagNodeLabel",
			"dagRunningState": "caqsjG_dagRunningState",
			"dagViewport": "caqsjG_dagViewport",
			"delegationSection": "caqsjG_delegationSection",
			"delegationTree": "caqsjG_delegationTree",
			"dependencySection": "caqsjG_dependencySection",
			"emptyHint": "caqsjG_emptyHint",
			"historicPill": "caqsjG_historicPill",
			"iconButton": "caqsjG_iconButton",
			"leadAvatar": "caqsjG_leadAvatar",
			"memberArt": "caqsjG_memberArt",
			"memberAvatar": "caqsjG_memberAvatar",
			"memberBlock": "caqsjG_memberBlock",
			"memberBranch": "caqsjG_memberBranch",
			"memberCount": "caqsjG_memberCount",
			"memberInfo": "caqsjG_memberInfo",
			"memberInitial": "caqsjG_memberInitial",
			"memberLine": "caqsjG_memberLine",
			"memberName": "caqsjG_memberName",
			"memberRole": "caqsjG_memberRole",
			"memberRow": "caqsjG_memberRow",
			"memberState": "caqsjG_memberState",
			"memberStatusLine": "caqsjG_memberStatusLine",
			"members": "caqsjG_members",
			"membersToggle": "caqsjG_membersToggle",
			"panel": "caqsjG_panel",
			"panelControls": "caqsjG_panelControls",
			"panelDot": "caqsjG_panelDot",
			"panelHead": "caqsjG_panelHead",
			"panelTitle": "caqsjG_panelTitle",
			"progressEmpty": "caqsjG_progressEmpty",
			"progressLegend": "caqsjG_progressLegend",
			"progressOverview": "caqsjG_progressOverview",
			"progressSegments": "caqsjG_progressSegments",
			"progressSummary": "caqsjG_progressSummary",
			"progressSummaryDot": "caqsjG_progressSummaryDot",
			"progressTitle": "caqsjG_progressTitle",
			"resizeHandle": "caqsjG_resizeHandle",
			"sectionHead": "caqsjG_sectionHead",
			"sectionHint": "caqsjG_sectionHint",
			"sectionTitle": "caqsjG_sectionTitle",
			"sectionToggleTitle": "caqsjG_sectionToggleTitle",
			"stageLabel": "caqsjG_stageLabel",
			"stateArt": "caqsjG_stateArt",
			"taskDetail": "caqsjG_taskDetail",
			"taskDetailBadge": "caqsjG_taskDetailBadge",
			"taskDetailHead": "caqsjG_taskDetailHead",
			"taskDetailId": "caqsjG_taskDetailId",
			"taskDetailLine": "caqsjG_taskDetailLine",
			"taskDetailMeta": "caqsjG_taskDetailMeta",
			"taskDetailSubject": "caqsjG_taskDetailSubject",
			"taskEmpty": "caqsjG_taskEmpty",
			"taskId": "caqsjG_taskId",
			"team": "caqsjG_team",
			"teamHead": "caqsjG_teamHead",
			"teamName": "caqsjG_teamName",
			"teamStats": "caqsjG_teamStats",
			"teams": "caqsjG_teams",
			"unreadPill": "caqsjG_unreadPill",
			"workGlyph": "caqsjG_workGlyph"
		};
		//#endregion
